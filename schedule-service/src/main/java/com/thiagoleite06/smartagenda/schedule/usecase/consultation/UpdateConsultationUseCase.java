...
public class UpdateConsultationUseCase {
    ...
    @Transactional
    public Consultation execute(Long id, UpdateConsultationInput input) {
        ...
        if (input.getScheduledAt() != null) {
            entity.setScheduledAt(input.getScheduledAt());
        }
        ...
        log.info("Consultation updated successfully with ID: {}", entity.getId());
